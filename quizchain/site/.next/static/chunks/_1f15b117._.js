...
function useQuizChain(params) {
    ...
    const loadFromIPFS = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useQuizChain.useCallback[loadFromIPFS]": async ()=>{
            try {
                ...
                const url = "https://ipfs.io/ipfs/".concat(ipfsCid);
                const res = await fetch(url);
                const arr = await res.json();
                setAllQuestions(arr);
                return arr;
            } catch (e) {
                setError("Load IPFS failed: " + (e === null || e === void 0 ? void 0 : e.message));
                return [];
            }
        }
    ...
    const answer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useQuizChain.useCallback[answer]": async (optionIndex)=>{
            ...
            try {
                ...
                if (isCorrect) setLocalScore({
                    "useQuizChain.useCallback[answer]": (s)=>s + 10
                ...
                setError("Submit failed: " + (e === null || e === void 0 ? void 0 : e.message));
            }
        }
    }["useQuizChain.useCallback[answer]"], [
        contract,
    ...
    const refreshScore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useQuizChain.useCallback[refreshScore]": async ()=>{
            // 临时：使用本地累计分数展示；后续可替换为 instance.userDecrypt(getEncryptedScore())
            setScoreClear(String(localScore));
        }
    }["useQuizChain.useCallback[refreshScore]"], [
        localScore
    ]);
...
_s(useQuizChain, "gWvk7Dy6u7t1TdGXxBznjWmW7C0=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                ...
                                children: (_qz_scoreClear1 = qz.scoreClear) !== null && _qz_scoreClear1 !== void 0 ? _qz_scoreClear1 : 0
                            }, void 0, false, {
                                fileName: "[project]/app/quiz/page.tsx",
                                lineNumber: 325,
                                columnNumber: 17
...
//# sourceMappingURL=_1f15b117._.js.map